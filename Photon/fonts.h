...
extern const unsigned char crystalclear_14ptBitmaps[];
extern const FONT_CHAR_INFO crystalclear_14ptDescriptors[];
extern const FONT_INFO crystalclear_14ptFontInfo;
