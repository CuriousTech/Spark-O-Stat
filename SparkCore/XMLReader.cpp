/*
  XMLReader.cpp - Spark specific Arduino library for simple serialized reading of XML.
...
// Initialize with a buffer, its length, and a callback to interate values in a list tag (item = tag#, idx = index in list, p = next value string)
