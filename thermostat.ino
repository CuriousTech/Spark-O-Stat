...
#define DHT_TEMP_ADJUST (-10)  // Adjust indoor temp by -1.0 degress
...
void drawButton(int8_t btn, bool bDown, bool bFast) // draw a button with pressed state and updated text
{
    ...
    switch(btn)
    {
        ...
        case 9: // mode
            ...
            break;
        case 10:
            pszText = (char *)(hvac.getHeatMode() ? "NG" : "HP");
            bg = bDown ? ILI9341_RED:ILI9341_BLUE;
            break;
...
void HandleTouch(bool bDown)
{
    ...
    switch(lastButton)
    {
        ...
        case 8: // Fan auto, on
            ...
            break;
        case 9: // off, Cool, heat, e-heat, auto
...
void setup()
{
    ...
    FcstInterval = 30; // first time = 30 seconds
    DrawButtons();
